...
public:
	...
	bool Load(WindowHandle hWindow, uint32_t width, uint32_t height, bool vSyncEnabled, ReloadDesc* pReloadDesc);
	...
	void UpdateDescriptorSet(DescriptorSet* pDescriptorSet, uint32_t index, uint32_t count, DescriptorData* pParams);
